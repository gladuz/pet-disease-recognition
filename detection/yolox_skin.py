...
train_ann_file = 'train_annotation_coco.json'
train_data_prefix = ''  # Prefix of train image path
# path of val annotation file
val_ann_file = 'valid_annotation_coco.json'
val_data_prefix = ''  # Prefix of train image path
...
auto_scale_lr = dict(base_batch_size=4 * train_batch_size_per_gpu)
val_cfg = dict(type='ValLoop')
test_cfg = dict(type='TestLoop')

visualizer = dict(vis_backends=[dict(type='LocalVisBackend'),dict(type='TensorboardVisBackend')])
#visualizer = dict(vis_backends=[dict(type='LocalVisBackend'), dict(type='WandbVisBackend')])
#load_from = "https://download.openmmlab.com/mmyolo/v0/yolox/yolox_s_fast_8xb8-300e_coco/yolox_s_fast_8xb8-300e_coco_20230213_142600-2b224d8b.pth"
load_from = "work_dirs/yolox_skin/best_coco/bbox_mAP_epoch_50.pth"